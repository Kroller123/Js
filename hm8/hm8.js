...
for (let i of coursesAndDurationArray) {
    ...
    div.innerText = `name of course : ${i.title} , need lern month : ${i.monthDuration}`
...
for (let i of coursesAndDurationArraySecond) {
    let div = document.createElement('div')
...
let firtsDiv = document.createElement('div')
...
for (let i of coursesArray) {
    ...
    month.innerText = i.monthDuration
    month.style.marginRight = '200px'


    let hour = document.createElement('h2')
    hour.innerText = i.hourDuration

    divSecond.style.display = 'flex'

    divSecond.append(month,hour)


    let divLast = document.createElement('div')
    let ul = document.createElement('ul')

    for (let k of i.modules) {
        let li = document.createElement('li')
        li.innerText = k
        ul.appendChild(li)
    }
    ...
    firtsDiv.append(div,divSecond,divLast)

    document.body.appendChild(firtsDiv)
}
